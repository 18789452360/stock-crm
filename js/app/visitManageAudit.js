 ...
 */
require(['vue', 'layui', 'common', 'ajaxurl', 'tools', 'layers', 'text!/assets/popup/visit-audit.html', 'text!/assets/popup/edit-remark.html', 'template'], function (Vue, layui, common, ajaxurl, tool, layers, visitAudit, editRemark, template) {
    ...
    var main = {
        ...
        visitPage: function() {
            ...
            tool.ajax({
                url: ajaxurl.visit.visit_view,
                type: 'post',
                data: {cooper_id: selCode},
                success: function(result){
                    if(result.code == 1){
                        // 渲染到vue数据层
                        vm.visitList = result.data;
