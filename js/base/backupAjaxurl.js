define(function () {
    ...
    var domain_product = baseUrl + '/admin/product/',
        ...
        domain_statistics = baseUrl + '/admin/statistics',
    ...
    return {
        ...
        productStock: {
            ...
            logList: domain_product + 'product_stock/crmAdmin?c=product_stock&a=logList',
            getAllStock: domain_product + 'product_stock/crmAdmin?c=product_stock&a=getAllStock',
            getOneStock: domain_product + 'product_stock/crmAdmin?c=product_stock&a=getOneStock'
        },
        productReport: {
            //------------------CRM系统的标的研报系列接口
            ...
            delete: domain_product + 'product_report/crmAdmin?c=product_report&a=deleteProductReport',
        ...
        productSuggest: {
            //------------------CRM系统的建议话术系列接口
            add: domain_product + 'product_suggestcontent/crmAdmin?c=product_suggest_content&a=add',
            editData: domain_product + 'product_suggestcontent/crmAdmin?c=product_suggest_content&a=editData',
            delete: domain_product + 'product_suggestcontent/crmAdmin?c=product_suggest_content&a=delete',
            edit: domain_product + 'product_suggestcontent/crmAdmin?c=product_suggest_content&a=edit'
        },
        material: {
            //------------------CRM系统的资料库系列接口
            ...
            addDocItem: domain_material + 'material/crmAdmin?c=materialDocument&a=add',
            delDocItem: domain_material + 'material/crmAdmin?c=materialDocument&a=delete',
            docList: domain_material + 'material/crmAdmin?c=materialDocument&a=index',
            editDocItem: domain_material + 'material/crmAdmin?c=materialDocument&a=edit',
            addDocCategory: domain_material + 'material/crmAdmin?c=materialDocument&a=categoryAdd',
            docCategoryList: domain_material + 'material/crmAdmin?c=materialDocument&a=categoryIndex',
            delCategoryItem: domain_material + 'material/crmAdmin?c=materialDocument&a=categoryDelete',
            editCategoryItem: domain_material + 'material/crmAdmin?c=materialDocument&a=categoryEdit',
            delDocArticle: domain_material + 'material/crmAdmin?c=materialDocumentArticle&a=delete',
            attachList: domain_material + 'material/crmAdmin?c=materialDocument&a=attach_list',
            logList: domain_material + 'material/crmAdmin?c=material&a=getLogList',
            addDcItem: domain_material + 'material/crmAdmin?c=materialDocumentArticle&a=add',
            editDcItem: domain_material + 'material/crmAdmin?c=materialDocumentArticle&a=edit',
            article: domain_material + 'material/crmAdmin?c=materialDocumentArticle&a=findInfoById',
            delAttach: domain_material + 'material/crmAdmin?c=materialDocument&a=delAttach',
        ...
        customer_cooper: {
            ...
            endcooper:domain_customer_cooper +'endcooper?c=customer_cooper_situation&a=endOffLineCooper'
        },
        ...
        setting: {
            ...
            line: baseUrl + '/admin/product/product/getlist?c=product&a=index&product_status=1&name=create_time&type=asc&pagesize=100000000',//线下数据信息
            editline: baseUrl + '/admin/globalsetting/setting/edit_offline?c=setting&a=editOffline',//线下数据信息
            getDataAuth:baseUrl + '/admin/globalsetting/setting/getlist?c=customer&a=getdataauth',//获取该员工的数据权限 list返回的是该员工没有的权限，有的权限不做返回
            backNotice:baseUrl + '/admin/globalsetting/setting/getlist?c=setting&a=backNotice',//展示设置的通知对象
            updateNotice:baseUrl + '/admin/globalsetting/setting/getlist?c=setting&a=updateNotice',//配置通知对象
            choiceNotice:baseUrl + '/admin/globalsetting/setting/getlist?c=setting&a=choice',//选择通知对象
        },
        //----------------------------------  IVR电话系列接口 -------------------
        ivr: {
        ...
        //--------------------------------- 项目、服务统计系列接口 ---------------------
        statistics:{
            project:domain_statistics + '/project_statistics/index?c=statistics&a=project',//项目统计
            service:domain_statistics + '/service_statistics/index?c=statistics&a=service',//服务统计
        },
        //----------------------------------  销售工作量统计系列接口 -------------------
        //----------------------------------   服务记录接口 -------------------
        service: {
         ...
         //----------------------------------  投诉管理接口 -------------------
        complaint: {
            myList: baseUrl + '/admin/complaint/complaint/my_complaint?c=complaint&a=my_complaint',//我（某个员工）的投诉记录
            recordList: baseUrl + '/admin/complaint/complaint/wait_complaint?c=complaint&a=complaint_record&flag=1',//待处理投诉
            allList: baseUrl + '/admin/complaint/complaint/all_complaint?c=complaint&a=complaint_record&flag=2',//全部投诉记录
            delcomplaint: baseUrl + '/admin/complaint/complaint/delcomplaint?c=complaint&a=delcomplaint',//删除投诉记录
            start: baseUrl + '/admin/complaint/complaint/start_complaint?c=complaint&a=start_complaint',//发起投诉
            details: baseUrl + '/admin/complaint/complaint/complaint_details?c=complaint&a=complaint_details',//投诉详情  
            solve: baseUrl + '/admin/complaint/complaint/solve_complaint?c=complaint&a=solve_complaint',//投诉处理
            edit: baseUrl + '/admin/complaint/complaint/edit_complaint?c=complaint&a=edit_complaint',//投诉编辑
            record: baseUrl + '/admin/complaint/complaint/solve_details?c=complaint&a=solve_details',//处理记录详情
        },
    }
});
